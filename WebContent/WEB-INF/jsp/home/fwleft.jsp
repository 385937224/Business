...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="yh" href="${ctx}fw/role_listUI.action" target="mainFrame1"><b></b>角色管理<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="yh" href="${ctx}fw/user_listUI.action" target="mainFrame1"><b></b>用户管理<s class="down"></s>
                    </a></dt>
                </dl>
                ...
                <dl class="">
                    <dt><a class="tssl" href="${ctx}fw/complain_listUI.action" target="mainFrame1"><b></b>投诉受理管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="nszx" href="#" target="mainFrame1"><b></b>纳税咨询管理<s class="down"></s> </a></dt>
                </dl>

                <dl class="">
                    <dt><a class="fwdc" href="#" target="mainFrame1"><b></b>服务调查管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="ygz" href="#" target="mainFrame1"><b></b>易告知管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="fwyy" style="cursor: pointer;"><b></b>服务预约管理<s class="down"></s> </a></dt>
                    <dd id="fwyygl" style="display:none;">
                        <a class="" href="#" target="mainFrame1"><b></b>预约服务</a>
                        <a class="" href="#" target="mainFrame1"><b></b>预约事项</a>
                    </dd>
                </dl>
            </div>
        </div>
