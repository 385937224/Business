...
<form id="form" name="form" action="${basePath}fw/info_edit.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        <tr>
            ...
            <td><s:select name="info.infoType" list="#request.infoTypeMap"/></td>
        ...
        <tr>
            ...
            <td>
            	<s:property value="info.creator" /><s:hidden name="info.creator"/>
            </td>
            <td class="tdBg" width="200px">创建时间：</td>
            <td>
            	<s:date name="info.createTime" /><s:hidden name="info.createTime"/>
            </td>
        </tr>
    </table>
